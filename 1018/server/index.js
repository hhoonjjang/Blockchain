...
// 서버 내의 프로퍼티 초기화 정의 생성
// processs는 프로그램에 대한 정보를 갖고 있다.
...
app.use((req, res, next) => {
  ...
  //   morgan을 사용 할 때 combined는 배포용으로 사용된다.
  else morgan("dev")(req, res, next);
  // dev는 개발 모드로 사용된다.
});

app.use("/", express.static(path.join(__dirname, "web")));
// '/' : 서버의 root, 즉 서버에 접근 시에 뒤에 라우터가 없을 때
//  라우터란? : 서버 내의 폴더
...
// querystring을 자동 파싱할 때 사용한 방법을 설정.
//모듈을 사용하지 않겠다.
